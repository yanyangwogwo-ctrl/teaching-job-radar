...
- 搜尋頁提供 `presetEnabled` 開關；「預設條件」分頁編輯 `subjectKeywords`、`roleKeywords` 及 `partTimeOnly`。科目任一 OR AND 職位名稱任一 OR；科目比對職位名、部門與內文（清理哲學學位、一般招聘頁尾及非教學的批判思考能力要求），職位名稱只比對標題。關閉開關會暫停三項預設限制，保留內容；手動 query／排除／院校／日期／狀態仍適用。
